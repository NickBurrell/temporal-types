...
// configuration step. It creates a namespace called `temporal_types`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", temporal_types::cmake::project_name, temporal_types::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", temporal_types::cmake::project_version);
      return EXIT_SUCCESS;
    }
